...
if ($connect) {
    ...
    if (isset($_POST['id'])) {
        $id = $_POST['id'];
        $progr = $db->query("select * from programs where id ='$id'");
        if ($progr->num_rows > 0) {
            while ($queryAll = $progr->fetch_object()) {
                $progrs_lot0[] = $queryAll;
            }
        }
        $cate3 = $db->query("select id , title2,title,description,Create_time, image from programs");
        if ($cate3->num_rows > 0) {
            while ($queryAll = $cate3->fetch_object()) {
                $logo_progrm[] = $queryAll;
            }
        }
        $logo_progrm = $progrs_lot0[0];
    }
}
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="m-5" action="./php/programEdit.php" method="post" enctype="multipart/form-data">

                                            <input type="hidden" class="form-control" name="id" value="<?= $logo_progrm->id ?? ' ' ?>">
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Title</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="title" value="<?= $logo_progrm->title ?? ' ' ?>" class="form-control ">
                                                </div>
                                            </div>

                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Second Title</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="title2" value="<?= $logo_progrm->title2 ?? ' ' ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">CreateDate</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" class="form-control" id="Create_time" name="Create_time" value="<?php echo date('l,  h:i ');  ?>" placeholder="UpdateDate">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Description</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <textarea type="text" name="description" class="summernote-simple"><?= $logo_progrm->description ?? ' ' ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
