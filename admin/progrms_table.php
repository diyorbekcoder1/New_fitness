...
if ($connect) {
    ...
    $card = [];
    $db3query = $db->query("SELECT * FROM programs");
                            ...
                            <div class="col-12 ">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Programs about</h4><strong>|</strong> <a href="../admin/program_create.php">
                                            <div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Program add</div>
                                        </a>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td><img style="width: 30px; height: 30px; border-radius: 50%;" src=" <?= $cards->image ?>" alt=""></td>
                                                                <td><?= $cards->Create_time ?></td>
                                                                <td> <?= substr($cards->description, 0, 15) ?></td>


                                                                <td style="width: 220px ">
                                                                    <form style="display: inline;" method="POST" action="./program_edit.php">
                                                                        <input hidden type="hidden" name="id" value="<?= $cards->id ?>">
                                                                        <button class="btn btn-icon icon-left btn-primary" type="submit"><i class="far fa-edit"></i>Edit</button>
                                                                    </form>

                                                                    <form style="display: inline;" method="POST" action="./php/programDelete.php">
