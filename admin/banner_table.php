...
if ($connect) {
    ...
    $banner = [];
    $db3query = $db->query("SELECT * FROM banners");
                            ...
                            <div class="col-12 ">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Banners settings</h4><strong>|</strong> <a href="../admin/banner_create.php">
                                            <div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Banners add</div>
                                        </a>
                                    </div>
                                            ...
                                            <table class="table table-bordered table-md">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                <th scope="row"><?= ++$key ?></th>
                                                                <td> <?= substr($banners->title, 0, 15) ?></td>
                                                                <td> <?= substr($banners->title2, 0, 15) ?></td>
                                                                <td><img style="width: 30px; height: 30px; border-radius: 50%;" src=" <?= $banners->image ?>" alt=""></td>
                                                                <td> <?= substr($banners->subtitle, 0, 15) ?></td>


                                                                <td style="width: 220px ">


                                                                    <form style="display: inline;" method="POST" action="./php/bannnerDelete.php">
                                                                        <input hidden type="hiddin" name="id" value="<?= $banners->id ?>">
