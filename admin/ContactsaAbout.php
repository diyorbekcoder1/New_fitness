                            ...
                            <div class="col-12 ">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Contacts</h4><strong>|</strong> <a href="./Contacts.php">
                                            <div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Contacts add</div>
                                        </a>
                                    </div>
                                            ...
                                            <table class="table table-bordered table-md">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                <th scope="row"><?= ++$key ?></th>
                                                                <td> <?= substr($contacts->name, 0, 20) ?></td>
                                                                <td> <?= substr($contacts->phone, 0, 20) ?></td>
                                                                <td> <?= substr($contacts->email, 0, 20) ?></td>
