...
if ($connect) {
    ...
    if (isset($_POST['id'])) {
        $id = $_POST['id'];
        $faqr = $db->query("select * from faqs where id ='$id'");
        if ($faqr->num_rows > 0) {
            while ($queryAll = $faqr->fetch_object()) {
                $faqs_edit[] = $queryAll;
            }
        }
        $cate3 = $db->query("select id , description,title,name, image from faqs");
        if ($cate3->num_rows > 0) {
            while ($queryAll = $cate3->fetch_object()) {
                $faqsTable[] = $queryAll;
            }
        }
        $faqsTable = $faqs_edit[0];
    }
}
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="m-5" action="./php/faqEdit.php" method="post" enctype="multipart/form-data">

                                            <input type="hidden" class="form-control" name="id" value="<?= $faqsTable->id ?? ' ' ?>">
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Name</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="name" value="<?= $faqsTable->name ?? ' ' ?>" class="form-control ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="title" value="<?= $faqsTable->title ?? ' ' ?>" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Description</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <textarea type="text" name="description" class="summernote-simple"><?= $faqsTable->description ?? ' ' ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
