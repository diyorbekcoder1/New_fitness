...
if ($connect) {
    ...
    $contact = [];
    $db3query = $db->query("SELECT * FROM brends_about");
    if ($db3query->num_rows > 0) {
        while ($queryAll = $db3query->fetch_object()) {
            $links_brend[] = $queryAll;
        }
    }
}
                            ...
                            <div class="col-12 ">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Brends</h4><strong>|</strong> <a href="./brand_create.php">
                                            <div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Brends add</div>
                                        </a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-md">
                                                ...
                                                <tbody>
                                                    <?php
                                                    if (isset($links_brend)) {
                                                        foreach ($links_brend as $key => $contacts) {

                                                    ?>
                                                            <tr>
                                                                <th scope="row"><?= ++$key ?></th>
                                                                <td><img style="width: 50px; height: 50px; " src=" <?= $contacts->image ?>" alt=""></td>
                                                                <td> <?= substr($contacts->link, 0, 30) ?></td>
                                                                <td style="width: 220px ">

                                                                    <form style="display: inline;" method="POST" action="./php/brendDelete.php">
