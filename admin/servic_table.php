                        ...
                        <div class="col-12 ">
                            <div class="card">
                                <div class="card-header">
                                    <h4>Services</h4><strong>|</strong> <a href="../admin/servis_create.php">
                                        <div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Services add</div>
                                    </a>
                                </div>
                                            ...
                                            if (isset($work)) {
                                                foreach ($work as $key => $works) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?= substr($works->bodytext, 0, 30) ?></td>

                                                        <td style="width: 220px ">

                                                            <form style="display: inline;" method="POST" action="./php/servicDelete.php">
