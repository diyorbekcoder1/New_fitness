...
if ($connect) {
    ...
    $quer2y = $db->query("SELECT * FROM menus");
                            ...
                            <div class="col-12 ">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Menu</h4><strong>|</strong> <a href="../admin/menu_create.php">
                                            <div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Menu add</div>
                                        </a>
                                    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td> <?= substr($works->link, 0, 20) ?></td>
                                                                <td> <?= substr($works->icon, 0, 20) ?></td>

                                                                <td style="width: 220px ">
                                                                    <!--                                                            <form  style="display: inline;" method="POST" action="./menu_edit.php">-->
                                                                    ...
                                                                    <!--                                                            </form>-->
                                                                    <form style="display: inline;" method="POST" action="./php/menuDelete.php">
