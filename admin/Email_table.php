...
if ($connect) {
    ...
    $card = [];
    $db3query = $db->query("SELECT * FROM subscribe");
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td style="width: 220px ">
                                                                    ...
                                                                    <form style="display: inline;" method="POST" action="./php/EmailDelete.php">
