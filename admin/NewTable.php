...
if ($connect) {
    ...
    $quer2y = $db->query("SELECT * FROM news");

    $work = [];
    if ($quer2y->num_rows > 0) {
        while ($queryAll = $quer2y->fetch_object()) {
            $work[] = $queryAll;
        }
    }
}
                            ...
                            <div class="col-12 ">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>News</h4><strong>|</strong> <a href="../admin/new_create.php">
                                            <div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">News add</div>
                                        </a>
                                    </div>
                                            ...
                                            <table class="table table-bordered table-md">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                <th scope="row"><?= ++$key ?></th>
                                                                <td> <?= substr($works->name, 0, 20) ?></td>
                                                                <td> <?= substr($works->title, 0, 20) ?></td>
                                                                <td> <?= substr($works->time, 0, 20) ?></td>

                                                                <td> <?= substr($works->email, 0, 10) ?></td>
                                                                <td> <?= substr($works->description, 0, 20) ?></td>

                                                                <td style="width: 220px ">
                                                                    <form style="display: inline;" method="POST" action="./newEdit.php">
                                                                    ...
                                                                    <form style="display: inline;" method="POST" action="./php/newDelete.php">
