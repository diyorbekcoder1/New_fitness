                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="m-5" action="./php/newCreate.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" class="form-control" id="time" name="time" value="<?php echo date("F j."); ?>" placeholder="UpdateDate">
                                                </div>
                                            </div>
