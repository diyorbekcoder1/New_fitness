...
if ($connect) {
    ...
    if (isset($_POST)) {
        $id = $_POST['id'];
        $trens = $db->query("select * from menus where id= $id");
        if ($trens->num_rows > 0) {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="m-5" action="./php/menuEdit.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="link " value="<?= $triner->link ?>" class="form-control ">
                                                </div>
                                            </div>


                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Icons</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="icon" value="<?= $triner->icon ?>" class="form-control ">
                                                </div>
                                            </div>
