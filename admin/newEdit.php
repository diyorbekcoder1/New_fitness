...
if ($connect) {
    ...
    if (isset($_POST)) {
        $id = $_POST['id'];
        $trens = $db->query("select * from news where id=$id");
        if ($trens->num_rows > 0) {
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="m-5" action="./php/Edit_New.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="name" value="<?= $triner->name ?>" class="form-control ">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" name="title " value="<?= $triner->title ?>" class="form-control ">
                                                </div>
                                            </div>
                                            <div class="form-group row mb-4">
                                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">CreateDate</label>
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="text" class="form-control" id="time" name="time" value="<?php echo date("Y-m-d h:i:s"); ?>" placeholder="UpdateDate">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <textarea type="text" name="description" class="summernote-simple"><?= $triner->description ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-sm-12 col-md-7">
                                                    <input type="email" name="email" value="<?= $triner->email ?>" class="form-control ">
                                                </div>
                                            </div>
