...
if ($connect) {
    ...
    $quer2y = $db->query("SELECT * FROM  logotips");
                            ...
                            <div class="col-12 ">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Moduls</h4><strong>|</strong> <a href="../admin/modul_create.php">
                                            <div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Moduls add</div>
                                        </a>
                                    </div>
                                            ...
                                            <table class="table table-bordered table-md">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                <th scope="row"><?= ++$key ?></th>
                                                                <td> <?= substr($works->title2, 0, 30) ?></td>
                                                                <td> <?= substr($works->bodytext, 0, 80) ?></td>


                                                                <td style="width: 220px ">
                                                                    <form style="display: inline;" method="POST" action="./php/modulDelete.php">
