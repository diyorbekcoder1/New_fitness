...
if ($connect) {
    ...
    $faq = [];
    $db3query = $db->query("SELECT * FROM faqs");
                            ...
                            <div class="col-12 ">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Faq</h4><strong>|</strong> <a href="../admin/faq_create.php">
                                            <div style="color: black;font-weight: bold" class=" ml-2  btn btn-success">Faqs add</div>
                                        </a>
                                    </div>
                                            ...
                                            <table class="table table-bordered table-md">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                <th scope="row"><?= ++$key ?></th>
                                                                <td> <?= substr($faqs->name, 0, 15) ?></td>
                                                                <td> <?= substr($faqs->title, 0, 15) ?></td>
                                                                <td><img style="width: 30px; height: 30px; border-radius: 50%;" src=" <?= $faqs->image ?>" alt=""></td>
                                                                <td> <?= substr($faqs->description, 0, 55) ?></td>


                                                                <td style="width: 220px ">
                                                                    <form style="display: inline;" method="POST" action="./faq_edit.php">
                                                                        <input hidden type="hidden" name="id" value="<?= $faqs->id ?>">
                                                                        <button class="btn btn-icon icon-left btn-primary" type="submit"><i class="far fa-edit"></i>Edit</button>
                                                                    </form>

                                                                    <form style="display: inline;" method="POST" action="./php/faqDelete.php">
                                                                        <input hidden type="hiddin" name="id" value="<?= $faqs->id ?>">
