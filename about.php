...
if ($connect) {
	...
	$logo_brends = $db->query("select  image,link  from brends_about ");
	...
	$logo_brend = [];
	if ($logo_brends->num_rows > 0) {
		while ($queryAll = $logo_brends->fetch_object()) {
			$logo_brend[] = $queryAll;
		}
	}
	...
	<section class="s-clients">
		<div class="container">
			<div class="row  justify-content-between">
				<?php foreach ($logo_brend as $logo_brenda) : ?>
					<div class="clients-cover">

					</div>
					<div class="client-slide ">
						<div class="client-slide-cover">
							<div> <a href="<?= $logo_brenda->link ?>"> <img src="<?= $logo_brenda->image ?>" alt="img"></a> </div>
						</div>
					</div>
